                    ...
                    <?php foreach ($current_bookings as $booking): ?>
                      <div class="assignment-card <?php echo isset($booking['location']) && $booking['location'] == 'makkah' ? 'makkah-card' : 'madinah-card'; ?>">
                        <div class="flex justify-between">
                          ...
                          <form method="POST" action="" class="delete-booking-form">
                            <input type="hidden" name="hotel_booking_id" value="<?php echo $booking['id']; ?>">
                            <input type="hidden" name="original_booking_id" value="<?php echo $current_booking['id']; ?>">
                      ...
                      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <script>
                          document.addEventListener('DOMContentLoaded', function() {
                            ...
                            // Open date picker when any part of the input is clicked
                            dateInput.addEventListener('click', function() {
                              this.showPicker();
                            });

                            // Optional: Validate date on change
                        ...
                        <script>
                          document.addEventListener('DOMContentLoaded', function() {
                            ...
                            // Disable manual typing
                            checkOutDate.addEventListener('keydown', function(e) {
                              e.preventDefault();
                              return false;
                            });
                            ...
                            // Optional: Add validation to ensure check-out is after check-in
                            checkOutDate.addEventListener('change', function() {
                              const checkInDate = document.getElementById('check_in_date');
                              if (checkInDate.value && this.value && new Date(this.value) <= new Date(checkInDate.value)) {
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function handleDelete(event, bookingId) {
        ...
        Swal.fire({
          title: 'Are you sure?',
          text: `You are about to delete hotel booking #${bookingId}. This action cannot be undone.`,
          icon: 'warning',
      ...
      deleteForms.forEach(form => {
        form.addEventListener('submit', function(event) {
          const bookingId = this.querySelector('input[name="hotel_booking_id"]').value;
          handleDelete(event, bookingId);
        });
      });
    });
    ...
    document.addEventListener('DOMContentLoaded', function() {
      ...
      tabButtons.forEach(button => {
        button.addEventListener('click', function() {
          // Get the tab name from the button's onclick attribute
    ...
    // Function to update room options when hotel is selected
