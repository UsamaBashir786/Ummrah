  ...
  <section id="packages" class="py-20 bg-gray-50">
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div class="flex flex-col lg:flex-row justify-between items-center mb-8 px-4">
        ...
        <a href="#packages" class="flex items-center text-teal-500 text-2xl py-2 px-4 rounded-lg transition duration-300 hover:underline" data-aos="zoom-in-up"> View Packages <i class="bx bx-chevron-right ml-2 text-2xl"></i> </a>
      </div>
      ...
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4">
        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 package-card relative border border-gray-200">
          <div class="mb-6">
            <img data-aos="zoom-in-right" src="assets/images/packages/1.jpg" loading="lazy" alt="Premium Hajj" class="w-full h-48 object-cover rounded-2xl mb-4 shadow-sm" />
            ...
            <p data-aos="zoom-in-right" class="text-4xl font-extrabold text-teal-600 mb-2">$590</p>
            <h3 data-aos="zoom-in-right" class="text-xl font-semibold text-gray-800 mb-2">Premium Hajj</h3>
            <p data-aos="zoom-in-right" class="text-gray-500 text-sm mb-4">Dec 10 - Dec 15</p>
          </div>
          ...
          <ul class="text-left space-y-4 text-gray-700 mb-6">
            ...
            <li class="flex items-center space-x-3">
              ...
              <span data-aos="zoom-in-right">5 Stars Hotel</span>
            </li>
            <li class="flex items-center space-x-3">
              <div class="bg-teal-100 text-teal-600 p-2 rounded-full shadow-sm">
          ...
          <a data-aos="zoom-in-right" href="packages.php" class="inline-block bg-gradient-to-r from-teal-600 to-teal-400 hover:from-teal-700 hover:to-teal-500 text-white font-medium py-3 px-5 rounded-xl shadow-md transition-all duration-300">
            Learn More
          </a>
        </div>
        <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 package-card relative border border-gray-200">
          <div class="mb-6">
            <img data-aos="zoom-in-right" src="assets/images/packages/2.jpg" alt="Premium Hajj" loading="lazy" class="w-full h-48 object-cover rounded-2xl mb-4 shadow-sm" />
            <div data-aos="zoom-in-right" class="absolute top-4 right-4 bg-teal-600 text-white text-sm font-semibold px-4 py-1 rounded-full shadow-md">
              Limited Offer
            </div>
            <p data-aos="zoom-in-right" class="text-4xl font-extrabold text-teal-600 mb-2">$590</p>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 package-card relative border border-gray-200">
          <div class="mb-6">
            <img data-aos="zoom-in-right" src="assets/images/packages/3.jpg" alt="Premium Hajj" loading="lazy" class="w-full h-48 object-cover rounded-2xl mb-4 shadow-sm" />
            <div data-aos="zoom-in-right" class="absolute top-4 right-4 bg-teal-600 text-white text-sm font-semibold px-4 py-1 rounded-full shadow-md">
              Limited Offer
            </div>
            <p data-aos="zoom-in-right" class="text-4xl font-extrabold text-teal-600 mb-2">$590</p>
        ...
        <div class="bg-white p-6 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 package-card relative border border-gray-200">
          <div class="mb-6">
            <img data-aos="zoom-in-right" src="assets/images/packages/4.jpg" alt="Premium Hajj" loading="lazy" class="w-full h-48 object-cover rounded-2xl mb-4 shadow-sm" />
            <div data-aos="zoom-in-right" class="absolute top-4 right-4 bg-teal-600 text-white text-sm font-semibold px-4 py-1 rounded-full shadow-md">
              Limited Offer
            </div>
            <p data-aos="zoom-in-right" class="text-4xl font-extrabold text-teal-600 mb-2">$590</p>
