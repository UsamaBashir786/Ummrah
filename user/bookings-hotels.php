...
<body class="bg-gray-100">
  ...
  <!-- Hotel Details Modal -->
  <div id="hotelDetailsModal" class="hotel-details-modal">
    <div class="modal-content">
      <div class="flex justify-between items-center mb-4">
        <h2 class="text-xl font-bold">Hotel Booking Details</h2>
      ...
      <div class="bg-white rounded-lg shadow-lg p-6 mb-8">
          ...
          <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
            ...
            <div class="bg-gradient-to-r from-green-400 to-green-500 rounded-lg p-4 text-white">
              ...
              <div class="text-3xl font-bold">
                ...
                while ($hotel = $hotel_bookings->fetch_assoc()) {
                  if ($hotel['booking_status'] == 'confirmed') $confirmed++;
                }
            ...
            <div class="bg-gradient-to-r from-yellow-400 to-yellow-500 rounded-lg p-4 text-white">
              ...
              <div class="text-3xl font-bold">
                ...
                while ($hotel = $hotel_bookings->fetch_assoc()) {
                  if ($hotel['check_in_date'] > $current_date && $hotel['booking_status'] != 'cancelled') $upcoming++;
                }
                ...
                <?php while ($hotel = $hotel_bookings->fetch_assoc()) { ?>
                  <tr class="hover:bg-gray-50 transition-colors duration-200">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                      <button onclick="viewHotelDetails(<?php echo $hotel['booking_id']; ?>)"
        ...
        <?php } else { ?>
          <div class="bg-gray-50 rounded-lg p-8 text-center">
            ...
            <a href="../hotels.php" class="mt-4 inline-block bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-6 rounded-lg transition duration-200 transform hover:scale-105 shadow-md">
              Book a Hotel
            </a>
          </div>
        <?php } ?>
